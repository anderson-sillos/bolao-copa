# Version Control Governance Specification

## Purpose

Definir a estratégia de branches, commits, pull requests, merges e releases que
mantém o histórico Git previsível e a branch principal protegida.
